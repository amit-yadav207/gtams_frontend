    ...
    <div className="min-h-screen bg-gray-100 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-6 text-gray-600">
          ...
          <p>
            Developed by Atlantic University, GTAMS leverages cutting-edge
            technology to optimize the efficiency and effectiveness of teaching
            assistant programs.
          </p>
          <div>
            <h2 className="text-3xl font-bold text-gray-800 mb-4">
              About Atlantic University
            </h2>
            <p>
              Atlantic University is a leading institution dedicated to
              innovation and excellence in education. With a commitment to
              fostering academic growth and research, Atlantic University
              prepares students for success in their chosen fields.
            </p>
            <p className="mt-4">
              Located in the heart of [Location], Atlantic University offers a
